...
from django.urls import reverse #used to generate URLs by reversing the URL patternse 
...
class Genre(models.Model):
    name = models.CharField(max_length=200, help_text='Enter a book genre (e.g. Scientific Fiction)')
